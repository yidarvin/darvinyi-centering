...
export const sources = [
  ...
  { text: 'J. G. L. A-Tjak et al., "The efficacy of Acceptance and Commitment Therapy," Psychotherapy and Psychosomatics 84, no. 1 (2015): 30–36. ACT’s mean effect around 0.42 versus controls, but a small and non-significant edge (around 0.16) over established cognitive-behavioral treatments: rough parity, not superiority.', url: 'https://pubmed.ncbi.nlm.nih.gov/25193001/' },
];
